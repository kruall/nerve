"""V49: repair tool-lease tables skipped by the duplicate V47 migration."""
...
async def up(db: aiosqlite.Connection) -> None:
    """Create the tool-lease schema idempotently for fresh and existing DBs."""
    await db.executescript(
        ...
        CREATE INDEX IF NOT EXISTS idx_tool_leases_expires_at
            ON tool_leases(expires_at);
    ...
    logger.info("v049: ensured durable tool leases and subscriptions exist")
